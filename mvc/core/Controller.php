...
class Controller{
    ...
    function  getview($view ){
        require_once './mvc/view/pages/'.$view.'.php';
    }
    function  getviewweb($view , $data){
        require_once './mvc/view/web/'.$view.'.php';
    }

    function Repaid($value){
        $strTitle=$value;
        $strTitle=str_replace('--','nguyenhuyentri',$strTitle);
