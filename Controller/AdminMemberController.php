...
class AdminMemberController
{
    ...
    function SaveAdd()
    {
        ...
        // die();
        $result = $this->AdminMemberModel->Insert(new Member($member_id, $member_name, $member_avatar, $member_job));
        if ($result == true)
    ...
    function SaveUpdate()
    {
        ...
        // echo $member_id.$member_name.$member_job. $member_avatar. $file_name;
        // die();
        $result = $this->AdminMemberModel->Update(new Member($member_id, $member_name, $member_avatar, $member_job));
        if ($result == true)
            header('location: index.php?c=AdminMember&a=View&r=1');
        else
            header('location: index.php?c=AdminMember&a=View&r=0');
