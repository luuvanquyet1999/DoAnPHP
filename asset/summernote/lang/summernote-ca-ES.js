  ...
  $.extend($.summernote.lang, {
    'ca-ES': {
      ...
      help: {
        ...
        'formatPara': 'Canviar l\'estil del bloc comment a un paràgraf (etiqueta P)',
        'formatH1': 'Canviar l\'estil del bloc comment a un H1',
        'formatH2': 'Canviar l\'estil del bloc comment a un H2',
        'formatH3': 'Canviar l\'estil del bloc comment a un H3',
        'formatH4': 'Canviar l\'estil del bloc comment a un H4',
        'formatH5': 'Canviar l\'estil del bloc comment a un H5',
        'formatH6': 'Canviar l\'estil del bloc comment a un H6',
