                            ...
                            <div class="add">
                                ...
                                <form action="index.php?c=Contact&a=SaveUpdate" method="post" >
                                    <table>
                                        <tr hidden>
                                            <td>Id</td>
                                            <td><input type="text" value="<?=$contact->contact_id?>"readonly name="contact_id" /></td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                            <td><input type="text" value="<?=$contact->contact_email?>"  name="contact_email" /></td>
                                        </tr>
                                        <tr>
                                            <td>Phone</td>
                                            <td><input type="text" value="<?=$contact->contact_phone?>"  name="contact_phone" /></td>
                                        </tr>
                                        <tr>
                                            <td>Address</td>
                                            <td><input type="text" value="<?=$contact->contact_address?>" name="contact_address" /></td>
                                        </tr>
                                        <tr >
                                            <td>Active</td>
                                            <td><input type="text"  value="<?=$contact->Active?>"  name="contact_Active" /></td>
                                        </tr>
                                        <tr>
                                            <td>
