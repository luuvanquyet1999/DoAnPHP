        ...
        <div class="header-area">
            <div class="main-header ">
                ...
                <div class="header-bottom header-sticky">
                    <div style="background-color: #ff2143;" class="container">
                                    ...
                                    <div class="trending-top mb-30">
                                        <div class="trend-top-img">
                                            ...
                                            <div class="trend-top-cap">
                                                ...
                                                <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by CongVien - Jun 19, 2020</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="properties__button">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Cách Sống</a>
                                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Du Lịch</a>
                                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Thời Trang</a>
                                                <a class="nav-item nav-link" id="nav-last-tab" data-toggle="tab" href="#nav-last" role="tab" aria-controls="nav-contact" aria-selected="false">Công Nghệ</a>
                                                ...
                                                <div class="col-xl-6 col-lg-12">
                                                    <div class="whats-news-single mb-40 mb-40">
                                                        ...
                                                        <div class="whates-caption">
                                                            ...
                                                            <span>by CongVien  -   Jun 19, 2020</span>
                                                            <p>Tính đến 6h ngày 30/6, theo Worldometers, thế giới ghi nhận 10.395.643 người nhiễm bệnh viêm đường hô hấp cấp Covid-19, trong đó có 507.416 ca tử vong và 5.646.130 người bình phục.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single mb-20">
                                                                ...
                                                                <div class="whats-right-cap">
                                                                    ...
                                                                    <h4><a href="latest_news.html">Xu hướng thời trang Thu Đông đang thu hút giới trẻ.</a></h4>
                                                                    <p>Jun 19, 2020</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single mb-20">
                                                                ...
                                                                <div class="whats-right-cap">
                                                                    <span class="colorb">Thời Trang</span>
                                                                    <h4><a href="latest_news.html">Tuần lễ thời trang Paris sắp khai mạc.</a></h4>
                                                                    <p>Jun 19, 2020</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single mb-20">
                                                                ...
                                                                <div class="whats-right-cap">
                                                                    ...
                                                                    <h4><a href="latest_news.html">Sơn Tùng có Gu thời trang mới lạ.</a></h4>
                                                                    <p>Jun 19, 2020</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single mb-20">
                                                                ...
                                                                <div class="whats-right-cap">
                                                                    ...
                                                                    <h4><a href="latest_news.html">Cách phối đồ cho người gầy.</a></h4>
                                                                    <p>Jun 19, 2020</p>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="recent-active dot-style d-flex dot-style">
                                ...
                                <div class="single-recent">
                                    ...
                                    <div class="what-cap">
                                        <h4>
                                            <a href="#">
                                                <h4><a href="latest_news.html">Tài năng trẻ tuổi "35"</a></h4>
                                            </a>
                                        </h4>
                                        <P>Jun 19, 2020</P>
                                        <a class="popup-video btn-icon" href="https://www.youtube.com/watch?v=g5WyB9akenE&t=151s"><span class="flaticon-play-button"></span></a>
                                ...
                                <div class="single-recent">
                                    ...
                                    <div class="what-cap">
                                        ...
                                        <P>Jun 19, 2020</P>
                                        <a class="popup-video" href="https://www.youtube.com/watch?v=g5WyB9akenE&t=151s"><span class="flaticon-play-button"></span></a>
                                    </div>
                                </div>
                                <!-- Single -->
                                <div class="single-recent">
                                    ...
                                    <div class="what-cap">
                                        <h4>
                                            <a href="latest_news.html">Tuổi tác không còn quang trọng với CR7</a>
                                        </h4>
                                        <P>Jun 19, 2020</P>
                                        <a class="popup-video" href="https://www.youtube.com/watch?v=g5WyB9akenE&t=151s"><span class="flaticon-play-button"></span></a>
                                    </div>
                                    ...
                                    <div class="what-cap">
                                        <h4>
                                            <a href="latest_news.html">
                                                <h4><a href="latest_news.html">Chủ nhân của 5 quả bóng vàng</a></h4>
                                            </a>
                                        </h4>
                                        <P>Jun 19, 2020</P>
                                        <a class="popup-video" href="https://www.youtube.com/watch?v=g5WyB9akenE&t=151s"><span class="flaticon-play-button"></span></a>
                            ...
                            <div class="testmonial-nav text-center">
                                <div class="single-video">
                                    ...
                                    <div class="video-intro">
                                        <h4>Cristiano ronaldo sút xa </h4>
                                    </div>
                                </div>
                                <div class="single-video">
                                    <video controls>
                                ...
                                <div class="single-video">
                                    ...
                                    <div class="video-intro">
                                        <h4>Cristiano Ronaldo Chung Kết UCL </h4>
                                    </div>
                                </div>
                                <div class="single-video">
                                    <video controls>
                                    ...
                                    <div class="video-intro">
                                        <h4>Cristiano Ronaldo vs Messi </h4>
                                    </div>
                                </div>
                            </div>
                        </div>
