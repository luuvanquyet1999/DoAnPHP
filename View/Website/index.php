    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="service-video set-bg" data-setbg="view/website/img/video-bg.jpg">
                    <div class="play-btn">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section-title">
                            <h2>Tin Nỗi Bật</h2>
                            <p>Những tin chính nỗi bật nhất trong tuần này.</p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2>Tin Mới Nhất</h2>
                    <p>Nhưng thông tín mới nhất được cập nhật</p>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="latest-items">
                    ...
                    <div class="latest-text">
                        <div class="latest-tag">
                            <div class="tag-clock">
                                <i class="fa fa-clock-o"></i> Dec 11, 2018
                            </div>
            ...
            <div class="col-lg-4">
                <div class="latest-items">
                    ...
                    <div class="latest-text">
                        <div class="latest-tag">
                            <div class="tag-clock">
                                <i class="fa fa-clock-o"></i> Dec 19, 2018
                            </div>
                            <div class="tag-comments">
                                <i class="fa fa-comments-o"></i> 6 Comments
                            </div>
            ...
            <div class="col-lg-4">
                <div class="latest-items">
                    ...
                    <div class="latest-text">
                        <div class="latest-tag">
                            <div class="tag-clock">
                                <i class="fa fa-clock-o"></i> Dec 23, 2018
                            </div>
                            <div class="tag-comments">
                                <i class="fa fa-comments-o"></i> 6 Comments
                            </div>
