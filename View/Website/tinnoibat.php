        ...
        <div class="menu-wrapper">
            <div class="portfolioFilter">
                <div class="portfolioFilter-inner">
                    ...
                    <a href="?c=Websitetinnoibat&a=View" data-filter="*" class="current">Tin Nỗi Bật</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="blog-section spad">
    <h2 style="text-align: center;margin-bottom: 30px;">Tin nổi bật nhất tuần qua?</h2>
    <h3 style="text-align: center;margin-bottom: 30px;">Câu lạc bộ Bayern Munich vô địch châu âu lần thứ 6.?</h3>
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-items">
                    <div class="single-blog-item">
                        ...
                        <div class="blog-text">
                            ...
                            <a href="./blog-details.html">
                                <h3>Lionel Messi muốn chấm dứt hợp đồng với Barcelona.</h3>
                            </a>
                    ...
                    <div class="single-blog-item">
                        <div class="blog-pic">
                            <img src="View/website/img/14.jpg" alt="">
                        </div>
                        <div class="blog-text">
                            <div class="blog-tag">
                                <div class="post-info">
