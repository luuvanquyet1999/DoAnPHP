                                ...
                                <div class="main-menu d-none d-md-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="categori.html">Thể Loại</a>
                                                <ul class="submenu">
                                                    <li><a href="#">Thể Thao</a></li>
                                                    <li><a href="#">Thời Trang</a></li>
                                                    <li><a href="#">Giai Trí</a></li>
                                                </ul>
                                            </li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="about-right mb-90">
                            <div class="about-img">
                                <img src="assets/img/trending/sontung1.jpg" alt="">
                            </div>
                            <div class="heading-news mb-30 pt-30">
                                <h3>MV Có chắc yêu là đây của Sơn Tùng M-TP: quá nhanh và quá nguy hiểm.</h3>
                            </div>
                            <div class="about-prea">
                                <p class="about-pera1 mb-25">Đây chắc chắn không phải bài hát hay (nhất) của Sơn Tùng, nhiều người bảo rằng thà nghe bản demo trên piano còn hay hơn. Nhưng việc ca khúc này quá nhanh, chưa kịp hiểu gì thì hết bài có phải là vấn đề của bài hát? Hay
                                    đây chính là chủ định của Sơn Tùng - một ngôi sao có hơi hướm quốc tế hóa. </p>
                            ...
                            <div class="section-tittle mb-30 pt-30">
                                <h3>Thế nhưng tại sao nhạc pop lại nhanh hơn?</h3>
                            </div>
                            <div class="about-prea">
                                <p class="about-pera1 mb-25">Sự nhạy cảm với xu hướng là một phẩm chất của Sơn Tùng, và phẩm chất ấy vẫn đang rất bén</p>

                                <p class="about-pera1 mb-25">
                                    "Tôi muốn đem tới cho mọi người những niềm hạnh phúc trong khoảng thời gian này, giúp họ không cần phải suy nghĩ nữa mà chỉ cần dừng lại và nhảy múa" - nữ ca sĩ Dua Lipa nói về những ca khúc với tempo nhanh mà cô phát hành trong album Future Nostalgia
                                    rất thành công hồi đầu năm. </p>
                            </div>
